...
import (
	"context"
	"fmt"
	"github.com/shynggys9219/ap2_microservices_project/statistics/internal/adapter/grpc/server/frontend"
	...
	frontendsvc "github.com/shynggys9219/ap2-apis-gen-statistics-service/service/frontend/client_stats/v1"
...
func (a *API) run(ctx context.Context) error {
	...
	frontendsvc.RegisterClientStatisticsServiceServer(a.s, frontend.NewClient(a.clientUsecase))
